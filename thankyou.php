<?php
$delay = 5;
// Redirect after the specified time delay
...
<html lang="en">
    ...
    <head>
        ...
        <title>Thank You | CT World School</title>
...
<body>
 ...
 <div class="conatiner">
    <div class="container-fluid mt-4 mb-4 ">
       <center><img src="img/thankyou.jpg" alt="thankyou" class="w-50 h-50 border border-success "></center> 
    </div>
 </div> 
